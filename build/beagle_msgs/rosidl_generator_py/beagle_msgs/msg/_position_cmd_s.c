...
bool beagle_msgs__msg__position_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("beagle_msgs.msg._position_cmd.PositionCmd", full_classname_dest, 41) == 0);
  }
  beagle_msgs__msg__PositionCmd * ros_message = _ros_message;
  {  // linecount
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * beagle_msgs__msg__position_cmd__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of PositionCmd */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("beagle_msgs.msg._position_cmd");
  ...
  beagle_msgs__msg__PositionCmd * ros_message = (beagle_msgs__msg__PositionCmd *)raw_ros_message;
  {  // linecount
    PyObject * field = NULL;
