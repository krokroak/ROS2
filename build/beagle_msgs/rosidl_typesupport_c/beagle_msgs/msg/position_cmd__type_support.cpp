...
static const _PositionCmd_type_support_symbol_names_t _PositionCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, beagle_msgs, msg, PositionCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, beagle_msgs, msg, PositionCmd)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, beagle_msgs, msg, PositionCmd)() {
  return &::beagle_msgs::msg::rosidl_typesupport_c::PositionCmd_message_type_support_handle;
}
