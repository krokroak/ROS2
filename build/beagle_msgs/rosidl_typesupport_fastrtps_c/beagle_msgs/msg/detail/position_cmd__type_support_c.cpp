...
#include "beagle_msgs/msg/detail/position_cmd__rosidl_typesupport_fastrtps_c.h"
...
using _PositionCmd__ros_msg_type = beagle_msgs__msg__PositionCmd;
...
size_t get_serialized_size_beagle_msgs__msg__PositionCmd(
  const void * untyped_ros_message,
...
static uint32_t _PositionCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_beagle_msgs__msg__PositionCmd(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_beagle_msgs
size_t max_serialized_size_beagle_msgs__msg__PositionCmd(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_beagle_msgs__msg__PositionCmd(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, beagle_msgs, msg, PositionCmd)() {
