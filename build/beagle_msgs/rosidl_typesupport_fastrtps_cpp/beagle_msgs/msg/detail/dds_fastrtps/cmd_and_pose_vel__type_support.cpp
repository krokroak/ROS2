...
#include "beagle_msgs/msg/detail/cmd_and_pose_vel__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const beagle_msgs::msg::CmdAndPoseVel *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<beagle_msgs::msg::CmdAndPoseVel *>(
    untyped_ros_message);
...
{
  return &beagle_msgs::msg::typesupport_fastrtps_cpp::_CmdAndPoseVel__handle;
}
