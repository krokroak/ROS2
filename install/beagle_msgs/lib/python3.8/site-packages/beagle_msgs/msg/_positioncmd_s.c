...
bool beagle_msgs__msg__positioncmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("beagle_msgs.msg._positioncmd.Positioncmd", full_classname_dest, 40) == 0);
  }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * beagle_msgs__msg__positioncmd__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Positioncmd */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("beagle_msgs.msg._positioncmd");
